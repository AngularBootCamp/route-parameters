...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["employee-employee-module"], {
  ...
  function srcAppEmployeeEmployeeDetailEmployeeDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EmployeeDetailComponent = function EmployeeDetailComponent(route) {
      ...
      this.id = route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (params) {
        return console.log('Got new value for param', params.get('employeeId'));
