...
class EmployeeDetailComponent {
    constructor(route) {
        ...
        this.id = route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(params => console.log('Got new value for param', params.get('employeeId'))), 
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(params => params.get('employeeId')));
    }
}
...
EmployeeDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EmployeeDetailComponent, selectors: [["employee-detail"]], decls: 7, vars: 3, consts: [[1, "card"], [1, "card-content"], [1, "card-title"]], template: function EmployeeDetailComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("Employee #", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](6, 1, ctx.id), "");
